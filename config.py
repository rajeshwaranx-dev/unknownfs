...
SHORTLINK_API_KEY = os.environ.get("SHORTLINK_API_KEY", "d59831297327ffa796efe4d63e44126b1a2c2e63")
...
TUT_VID = os.environ.get("TUT_VID","https://t.me/boo78id")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "5102717153,5371238852").split()):
        ADMINS.append(int(x))
except ValueError:
